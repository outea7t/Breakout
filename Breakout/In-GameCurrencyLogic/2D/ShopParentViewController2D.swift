...
class ShopParentViewController2D: UIViewController {
    ...
    public var cellData = [Shop2DCellData]()
    
    internal let cellIdentifier = "Shop2DCollectionViewCell"
    ...
    public var selectedCell: ShopCollectionViewCell?
    public var actualPositionOfSelectedCell = CGPoint()
    ...
    @objc public func longPressGesture(_ gesture: UILongPressGestureRecognizer) {
...
extension ShopParentViewController2D: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.setup(with: self.cellData[indexPath.row])
...
extension ShopParentViewController2D: UICollectionViewDelegateFlowLayout {
...
// обработка нажатий
extension ShopParentViewController2D: UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didUnhighlightItemAt indexPath: IndexPath) {
        ...
        guard self.selectedCellIndexPath != indexPath else {
            return
        }
