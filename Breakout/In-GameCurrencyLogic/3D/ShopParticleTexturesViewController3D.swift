...
class ShopParticlesTexturesViewController3D: UIViewController, TexturesShopController {
    ...
    private var particlesCellData = [Shop3DCellData]()
...
//        ]
    ...
    private func doesBuyedItemsContains(item: IndexPath) -> Bool {
        ...
        for index in UserCustomization._3DbuyedParticlesSkinIndexes {
            if index == item.item {
                doesContain = true
            }
        }
...
extension ShopParticlesTexturesViewController3D: UICollectionViewDataSource {
...
extension ShopParticlesTexturesViewController3D: UICollectionViewDelegateFlowLayout {
    // по две в ряду
...
extension ShopParticlesTexturesViewController3D: UICollectionViewDelegate {
